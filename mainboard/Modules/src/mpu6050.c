...
bool MPU6050Init(void) {
    ...
    // HAL_Delay(250);
    // printf("HAL_I2C_IsDeviceReady\r\n");
    bool flag = I2C1Read(MPU6050_DEV_ADDR, MPU6050_WHO_AM_I, 1, &i2c_data, 1);
    // HAL_I2C_Mem_Read_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_WHO_AM_I, 1, &i2c_data, 1);
    // while (hi2c1.State == HAL_I2C_STATE_BUSY);
    // if(HAL_I2C_Mem_Read_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_WHO_AM_I, 1, &i2c_data, 1) != HAL_OK) {
    //     printf("error\r\n");
    // }
    ...
    if (!flag || i2c_data != 0x68) return false;
    ...
    // }
    // // HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_PWR_MGMT_1, 1, &i2c_data, 1);
    ...
    // i2c_data = 0x07;
    // if(HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_SMPLRT_DIV, 1, &i2c_data, 1) != HAL_OK) {
    //     printf("MPU6050_SMPLRT_DIV\r\n");
    // }
    // // HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_SMPLRT_DIV, 1, &i2c_data, 1);
    ...
    // i2c_data = 0x00;
    // if(HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_ACCEL_CONFIG, 1, &i2c_data, 1) != HAL_OK) {
    //     printf("MPU6050_ACCEL_CONFIG\r\n");
    // }
    // // HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_ACCEL_CONFIG, 1, &i2c_data, 1);
    ...
    // i2c_data = 0x18;
    // if(HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_GYRO_CONFIG, 1, &i2c_data, 1) != HAL_OK) {
    //     printf("MPU6050_GYRO_CONFIG\r\n");
    // }
    // // HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_GYRO_CONFIG, 1, &i2c_data, 1);
    // // HAL_I2C_Mem_Write(&hi2c1, MPU6050_DEV_ADDR, MPU6050_GYRO_CONFIG, 1, &i2c_data, 1, 1000);
    // // HAL_Delay(5);

    // //// enable I2C bypass for AUX I2C
    // i2c_data = 0x02;
    // if(HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_RA_INT_PIN_CFG, 1, &i2c_data, 1) != HAL_OK) {
    //     printf("MPU6050_RA_INT_PIN_CFG\r\n");
    // }
    // // HAL_I2C_Mem_Write_DMA(&hi2c1, MPU6050_DEV_ADDR, MPU6050_RA_INT_PIN_CFG, 1, &i2c_data, 1);
...
// uint8_t MPU6050ReadAccel(float *accel_x, float *accel_y, float *accel_z) {
// 	if (HAL_I2C_Mem_Read(&hi2c1, MPU6050_DEV_ADDR, MPU6050_ACCEL_XOUT_H, 1, i2c_datas, 6, 1000) !=  HAL_OK) {
//         return 0;
//     }
//     // HAL_Delay(10);
